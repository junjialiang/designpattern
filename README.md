...
备忘录模式：
----------------------------------------------------------------------------
类名：org.springframework.binding.message.StateManageableMessageContext

命令模式：
----------------------------------------------------------------------------
类名：java.lang.Runnable

类名：junit.framework.Test
...
责任链模式：
----------------------------------------------------------------------------
类名：javax.servlet.Filter

访问者模式
----------------------------------------------------------------------------
类名：java.nio.file.FileVisitor

类名：org.springframework.beans.factory.config.BeanDefinitionVisitor

状态模式
----------------------------------------------------------------------------
类名：javax.faces.lifecycle.Lifecycle
